	...
	if ( $field['field'] == 'Select2 (Multiple)' ){
		...
		if ( $form_location != 'back_end' ){
			...
			$output = '
				...
				<select name="'.$field['meta-name'].'[]" id="'.wppb_sl2_multiple_handle_meta_name( $field['meta-name'] ).'" class="custom_field_select2" multiple="multiple" '. $extra_attr .' data-wppb-select2-arguments=\'' .  json_encode($arguments) . '\'>';
			...
			$output = '
				<table class="form-table wppb-select2">
					<tr>
						...
						<td>
							<select name="'.$field['meta-name'].'[]" class="custom_field_select2" id="'.wppb_sl2_multiple_handle_meta_name( $field['meta-name'] ).'" multiple="multiple" '. $extra_attr .' data-wppb-select2-arguments=\'' . json_encode($arguments)  . '\'>';
