	...
	if ( $field['field'] == 'Select2' ){
		...
		if ( $form_location != 'back_end' ){
			...
			$output = '
				...
				<select name="'.$field['meta-name'].'" id="'.$field['meta-name'].'" class="custom_field_select2" '. $extra_attr .' data-wppb-select2-arguments=\'' . json_encode($arguments)  . '\'>';
			...
			$output = '
				<table class="form-table wppb-select2">
					<tr>
						...
						<td>
							<select name="'.$field['meta-name'].'" class="custom_field_select2" id="'.$field['meta-name'].'" '. $extra_attr .' data-wppb-select2-arguments=\'' . json_encode($arguments)  . '\'>';
